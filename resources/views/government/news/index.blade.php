    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="lead mb-4">Stay informed about the latest news, announcements, and events from the Micheweni District Council.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="card border-0 bg-light">
                <div class="card-body">
                    <p class="text-center text-muted mb-3">This project was funded by:</p>
                    <div class="d-flex justify-content-center align-items-center flex-wrap gap-5">
                        <div class="text-center">
                            <img src="{{ asset('images/logos/globalgatewaylogo.png') }}" alt="Global Gateway" height="60"  onerror="this.src='{{ asset('images/placeholder-logo.png') }}'; this.onerror=null;">
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('images/logos/europeanunionlogo.png') }}" alt="European Union" height="60"  onerror="this.src='{{ asset('images/placeholder-logo.png') }}'; this.onerror=null;">
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('images/logos/enabellogo.png') }}" alt="Enabel" height="40" width="100"  onerror="this.src='{{ asset('images/placeholder-logo.png') }}'; this.onerror=null;">
                        </div>
                    </div>
                </div>
            </div>
