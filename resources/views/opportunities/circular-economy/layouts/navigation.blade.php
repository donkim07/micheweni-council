    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-4 col-md-3 d-flex align-items-center justify-content-start">
                <div>
                    <img src="{{ asset('images/logo.png') }}" alt="Micheweni Government" class="logo-img img-fluid">
                </div>
            </div>
            ...
            <div class="col-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <h1 class="government-title">MICHEWENI WASTE MANAGEMENT</h1>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-success sticky-navbar" id="main-navbar">
    <div class="container">
        <a class="navbar-brand d-lg-none" href="{{ url('/') }}">
            <img src="{{ asset('images/logo.png') }}" alt="{{ config('app.name', 'Micheweni Waste Portal') }}" height="40" class="d-inline-block align-text-top me-2">
        </a>
